    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-background">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-[11px] font-semibold text-muted-foreground mb-1.5 block uppercase tracking-wide">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="text-[11px] font-semibold text-muted-foreground mb-1.5 block uppercase tracking-wide">Password</label>
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full h-12 rounded-2xl bg-primary text-primary-foreground font-semibold text-sm shadow-lg shadow-primary/20 transition-all disabled:opacity-50 disabled:shadow-none"
          >
            {loading ? (
        ...
        <button
          ...
          className="w-full text-center text-sm text-muted-foreground mt-5 py-2 active:opacity-70"
        >
